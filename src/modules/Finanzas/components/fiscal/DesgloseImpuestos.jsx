// ============================================================================
// SISTEMA GM · M-09 TESORERÍA · IMPUESTOS DEL MES
// ----------------------------------------------------------------------------
    ...
    <div>
      <div className="mb-1.5 flex flex-wrap items-baseline justify-between gap-2">
        <div>
          ...
          <span className="ml-2 text-[12px] text-[var(--gm-texto-medio)] dark:text-[#6B7280]">{detalle}</span>
        </div>
  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-wrap items-end justify-between gap-3 rounded-xl bg-[#FCFAF6] dark:bg-[#2D2D2D] p-4">
        <div>
          <p className="text-[11px] font-semibold uppercase tracking-[0.1em] text-[var(--gm-texto-medio)] dark:text-[#6B7280]">
            Sobre ventas de
          </p>
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 border-t border-[var(--gm-borde-fuerte)] dark:border-[#333333] pt-4">
