          ...
          <button
            ...
            className={`inline-flex items-center gap-2 rounded-full border px-3.5 py-2 text-[13px] transition ${
              activo
                ...
                : 'border-[#E8E0D5] dark:border-[#333333] bg-[#FFFFFF] dark:bg-[#1E1E1E] text-[#6E6559] dark:text-[#9CA3AF] hover:border-[#D5CABA] hover:bg-[#FCFAF6] dark:hover:bg-[#2D2D2D]'
            }`}
          >
            ...
            <span
              className={`rounded-full px-1.5 py-0.5 text-[11px] font-semibold ${
                activo ? 'bg-[#FFFFFF] dark:bg-[#1E1E1E] text-[#8A3F11]' : 'bg-[#EFE7DB] text-[#5B5347]'
              }`}
            >
              {o.cantidad}
            </span>
