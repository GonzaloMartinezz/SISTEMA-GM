// ============================================================================
// SISTEMA GM · M-07 · CALENDARIO DE COBROS
// ----------------------------------------------------------------------------
  ...
  return (
    <div className="overflow-x-auto">
      <div className="min-w-[560px]">
        <div className="grid grid-cols-7 border-b border-[var(--gm-borde-fuerte)]">
          {DIAS_SEMANA.map((d) => (
            <div
              key={d}
              className="px-2 py-2 text-center text-[11px] font-semibold uppercase tracking-[0.1em] text-[var(--gm-texto-medio)]"
            >
              {d}
            </div>
          ))}
          ...
          {semanas.flat().map((dia) => {
            ...
            return (
              <button
                ...
                className={`flex min-h-[86px] flex-col items-start gap-1 border-b border-r border-[var(--gm-divisor)] px-2 py-1.5 text-left transition ${
              ...
              >
                ...
                {dia.cuotas.length > 0 && (
                  <>
                    ...
                    <span className="w-full truncate text-[10px] leading-tight text-[var(--gm-texto-medio)]">
                      {dia.cuotas.length === 1
